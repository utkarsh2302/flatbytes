            ...
            {flats.map((flat) => {
              ...
              return (
                ...
                >
                  ...
                  {/* WhatsApp quick contact — available flats only */}
                  {!isSold && (
                    <div className="px-4 pb-2">
                      <a
                        href={`https://wa.me/?text=${encodeURIComponent(`Hi, I'm interested in Flat ${flat.flat_number} (${FLAT_TYPE_LABELS[flat.flat_type] ?? flat.flat_type}, Floor ${flat.floor}) at ${flat.project_name}. Please share pricing details.`)}`}
                        target="_blank"
